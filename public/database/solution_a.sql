...
-- 8. Lấy ra danh sách người dùng trong đó email người dùng là Gmail (ví dụ: example@gmail.com), tên người dùng có chất 'v' và tên người dùng có chiều dài lớn hơn 5
SELECT *
FROM users
WHERE user_email LIKE '%@gmail.com'
AND user_name LIKE '%v%'
AND LENGTH(user_name) > 5;

-- 9. Lấy ra danh sách người dùng trong đó tên người dùng có chữ 'a', chiều dài từ 5 đến 9, email dùng dịch vụ Gmail, trong tên email có chữ 'I' (trong tên, chứ không phải domain exampletestI@yahoo.com)
SELECT *
FROM users
WHERE user_name LIKE '%a%'
